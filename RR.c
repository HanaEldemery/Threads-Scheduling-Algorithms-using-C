...
int main(){
    ...
    param_rr.sched_priority = sched_get_priority_max(SCHED_RR);
    pthread_setschedparam(ptid1, SCHED_RR, &param_rr);
    pthread_setschedparam(ptid2, SCHED_RR, &param_rr);
    pthread_setschedparam(ptid3, SCHED_RR, &param_rr);
    pthread_setschedparam(ptid4, SCHED_RR, &param_rr);
