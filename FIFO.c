...
int main(){
    ...
    pthread_setschedparam(ptid1, SCHED_FIFO, &param_fifo);
    pthread_setschedparam(ptid2, SCHED_FIFO, &param_fifo);
    pthread_setschedparam(ptid3, SCHED_FIFO, &param_fifo);
    pthread_setschedparam(ptid4, SCHED_FIFO, &param_fifo);
